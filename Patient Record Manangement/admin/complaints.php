...
<?php
	...
	require_once 'add_complaints.php';
?>
<html lang = "eng">
	<head>
	...
	<div id = "content">
		...
		<div style = "display:none;" id = "com" class = "panel panel-success">	
			...
			?>
				<form method = "POST" enctype = "multipart/form-data">
					...
					<div class = "form-inline">
						<button class = "btn btn-primary" name = "save_complaints" id="save_complaints"><span class = "glyphicon glyphicon-save"></span> SAVE</button>
					</div>
		...
		<div class = "panel-body">
			<?php
				...
				$f1 = $q1->fetch_array();
				$q = $conn->query("SELECT * FROM `complaints` WHERE `itr_no` = '$_GET[id]' ORDER BY `date` DESC") or die(mysqli_error());	
					while($f = $q->fetch_array()){
						...
						if($f['status'] == "Pending"){
							echo "<label style = 'color:#3399f3;'> Section: ".$f['section']."</label>"." <textarea  style = 'resize:none;' disabled = 'disabled' class = 'form-control'>Complaints: ".$f['complaints']." </textarea> <br /><br /><textarea  style = 'resize:none;' disabled = 'disabled' class = 'form-control'>Remarks: ".$f['remark']."</textarea>Date: ".$f['date']."<br /><br /><hr style = 'border:1px solid #eee;' />";
						}
					}
				?>
		</div>
